...
public class StateMachineRuleSet2 extends StateMachineRuleSet {
	...
	migrationRule = new MigrationRule2(p, env);
	...
	if (sdm == null) {
	    die("[StatemachineRuleSet2.initialize] state diagram model is null");
	}
