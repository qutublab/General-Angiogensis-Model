...
public class RuleSetMPMB extends SimpleRuleSet {
	...
	"Migration, Proliferation, Migration, Branching";
    ...
    */
	...
	Parameters p =
	    new Parameters(e.getAngiogenesisParametersFileName());
	...
	migrationRule = new MigrationRule(p, e, .5);
